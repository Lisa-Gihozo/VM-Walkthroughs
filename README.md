...
Each machine has its own dedicated directory organized into three professional artifacts:
    ...
    README.md: Executive summary and severity rating.

    Methodology.md: Step-by-step technical walkthrough of the exploit chain.

    Remediation.md: Defensive recommendations and hardening guides based on NIST/OWASP standards.
